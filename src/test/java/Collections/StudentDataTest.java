...
public class StudentDataTest {
    ...
    public void testRemoveStudentSuccess() {
        ...
        students.add(new Student("Goutham", "Jai", 3.5));
        students.add(new Student("Ram", "A", 3.1));
    ...
    public void testRemoveStudentEdge() {
        ArrayList<Student> students = new ArrayList<>();
        students.add(new Student("Goutham", "Jai", 3.5));
        students.add(new Student("Ram", "A", 3.5));
        students.add(new Student("MahaDev", "B", 3.5));
        studentData.removeStudentsByGPA(students);
    ...
    public void testStudentDataByNameFailure() {
        Student student = studentData.getStudentData("Goutam");
